...
public class NormalGame5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        z[16] = (LinearLayout)findViewById(R.id.z17);
        z[17] = (LinearLayout)findViewById(R.id.z18);
        z[18] = (LinearLayout)findViewById(R.id.z19);
        z[19] = (LinearLayout)findViewById(R.id.z20);
        z[20] = (LinearLayout)findViewById(R.id.z21);
        z[21] = (LinearLayout)findViewById(R.id.z22);
        z[22] = (LinearLayout)findViewById(R.id.z23);
        z[23] = (LinearLayout)findViewById(R.id.z24);
        z[24] = (LinearLayout)findViewById(R.id.z25);
    ...
    public void checkZ(LinearLayout zone){
        ...
        for(int i = 0; i<5 ; i++ ){
            if((temp_status[i][0]!=0)&&(temp_status[i][0]==temp_status[i][1])&&(temp_status[i][1]==temp_status[i][2])&&(temp_status[i][2]==temp_status[i][3])&&(temp_status[i][3]==temp_status[i][4]))
            {
                win = current_player;
            }
            else if((temp_status[0][i]!=0)&&(temp_status[0][i]==temp_status[1][i])&&(temp_status[1][i]==temp_status[2][i])&&(temp_status[2][i]==temp_status[3][i])&&(temp_status[3][i]==temp_status[4][i])){
                win = current_player;
            }
        }

        if((win == 0)&&(temp_status[1][1]!=0)&&(temp_status[0][0] == temp_status[1][1])&&( temp_status[1][1]== temp_status [2][2])&&( temp_status[2][2]== temp_status [3][3])&&( temp_status[3][3]== temp_status [4][4])){
            win = current_player;
        }

        if((win == 0)&&(temp_status[0][4]!=0)&&(temp_status[0][4] == temp_status[1][3])&&( temp_status[1][3]== temp_status [2][2])&&( temp_status[2][2]== temp_status [3][1])&&( temp_status[3][1]== temp_status [4][0])){
            win = current_player;
        }
        ...
        switch(zone.getId()){
            ...
            case R.id.z5 :
                if( win!=0){
                    main_game_status[0][4] = current_player;
                }
                if (draw == 1){
                    main_game_status[0][4] = 5;
                }
                break;
            case R.id.z6 :
                if( win!=0){
            ...
            case R.id.z10 :
                if( win!=0){
                    main_game_status[1][4] = current_player;
                }
                if (draw == 1){
                    main_game_status[1][4] = 5;
                }
                break;
            case R.id.z11 :
                if( win!=0){
            ...
            case R.id.z15 :
                if( win!=0){
                    main_game_status[2][4] = current_player;
                }
                if (draw == 1){
                    main_game_status[2][4] = 5;
                }
                break;
            case R.id.z16 :
                if( win!=0){
            ...
            case R.id.z20 :
                if( win!=0){
                    main_game_status[3][4] = current_player;
                }
                if (draw == 1){
                    main_game_status[3][4] = 5;
                }
                break;
            case R.id.z21 :
                if( win!=0){
                    main_game_status[4][0] = current_player;
                }
                if (draw == 1){
                    main_game_status[4][0] = 5;
                }
                break;
            case R.id.z22 :
                if( win!=0){
                    main_game_status[4][1] = current_player;
                }
                if (draw == 1){
                    main_game_status[4][1] = 5;
                }
                break;
            case R.id.z23 :
                if( win!=0){
                    main_game_status[4][2] = current_player;
                }
                if (draw == 1){
                    main_game_status[4][2] = 5;
                }
                break;
            case R.id.z24 :
                if( win!=0){
                    main_game_status[4][3] = current_player;
                }
                if (draw == 1){
                    main_game_status[4][3] = 5;
                }
                break;
            case R.id.z25 :
                if( win!=0){
                    main_game_status[4][4] = current_player;
                }
                if (draw == 1){
                    main_game_status[4][4] = 5;
                }
                break;
        }
        checkMain();
    ...
    public void checkMain(){
        ...
        //checking rows and columns
        for(int i = 0; i<5 ; i++ ){
            if((main_game_status[i][0]!=0)&&(main_game_status[i][0]==main_game_status[i][1])&&(main_game_status[i][1]==main_game_status[i][2])&&(main_game_status[i][2]==main_game_status[i][3])&&(main_game_status[i][3]==main_game_status[i][4]))
            {
                win = current_player;
            }
            else if((main_game_status[0][i]!=0)&&(main_game_status[0][i]==main_game_status[1][i])&&(main_game_status[1][i]==main_game_status[2][i])&&(main_game_status[2][i]==main_game_status[3][i])&&(main_game_status[3][i]==main_game_status[4][i])){
                win = current_player;
            }
        }

        if((win == 0)&&(main_game_status[1][1]!=0)&&(main_game_status[1][1]!=5)&&(main_game_status[0][0] == main_game_status[1][1])&&( main_game_status[1][1]== main_game_status [2][2])&&( main_game_status[2][2]== main_game_status [3][3])&&( main_game_status[3][3]== main_game_status [4][4])){
            win = current_player;
        }

        if((win == 0)&&(main_game_status[0][4]!=0)&&(main_game_status[0][4]!=5)&&(main_game_status[0][4] == main_game_status[1][3])&&( main_game_status[1][3]== main_game_status [2][2])&&( main_game_status[2][2]== main_game_status [3][1])&&( main_game_status[3][1]== main_game_status [4][0])){
            win = current_player;
        }
    ...
    public void setupZ(LinearLayout zone){
        ...
        now.setColumnCount(5);
        now.setRowCount(5);
        now.setTag("zone");
        Button[] game_buttons = new Button[25];
        for(int i = 0; i<25 ; i++){
            ...
            lp.width = (int)getResources().getDisplayMetrics().density*10;
            lp.height = (int)getResources().getDisplayMetrics().density*10;
